...
module.exports = {
  npmEntry (nodeModulesTree, yarnObject, mPath, isV2) {
    ...
    if (entryInYarnFile.integrity) {
      entry.integrity = entryInYarnFile.integrity
    }
    ...
    if (isV2) {
      ...
      if (!entry.integrity || /^file:/.test(entry.resolved)) {

...
function createEntry (key, manifest, node, entries) {
  ...
  entry.data = {
    ...
    dependencies: Object.keys(manifest.dependencies).length > 0 ? manifest.dependencies : null,
    optionalDependencies: Object.keys(manifest.optionalDependencies).length > 0 ? manifest.optionalDependencies : null,
